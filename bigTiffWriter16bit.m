classdef bigTiffWriter16bit < ImageAdapter
    ...
    methods
        ...
        function obj = bigTiffWriter16bit(fname, imageLength, imageWidth, tileLength, tileWidth)
            % Constructor
            ...
            obj.TiffObject.setTag('Compression', Tiff.Compression.PackBits);
